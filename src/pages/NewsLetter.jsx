  ...
  return (
    <div className='m-7 rounded-3xl relative md:p-10 '>
      <div className='grid grid-cols-1 border rounded-3xl bg-titleCol relative overflow-hidden md:grid-cols-2 md:static '>
        ...
        <div className='col-span-1 m-7 md:col-span-1 md:w-[250px] md:mt-10'>
          ...
          <div className='grid grid-cols-2 gap-2 border bg-fullCol rounded-full px-3 py-3'>
            <input className='col-span-1 border-none outline-none text-sm md:text-md' type="text" placeholder='Enter Email'/>
            <button className='col-span-1 text-sm bg-orange text-fullCol rounded-full text-center md:text-md'>
